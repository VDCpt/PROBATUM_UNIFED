...
(function _installLegalTacticsEngine(root) {
    ...
    /* ======================================================================
       INTERFACE PÚBLICA (NAMESPACE OPERACIONAL)
       ====================================================================== */

    // PATCH-LE-01: Permitir instanciação de Singleton (_instance definido explicitamente)
    const PUBLIC_API = {
        _INSTALLED: true,
        _VERSION: '1.0.0-LEGAL-TACTICS',
        _TIMESTAMP: new Date().toISOString(),
        _instance: null,  // ← DEFINE EXPLICITAMENTE PARA EVITAR TypeError
    ...
    // Freeze APÓS definição de _instance para evitar "object is not extensible"
